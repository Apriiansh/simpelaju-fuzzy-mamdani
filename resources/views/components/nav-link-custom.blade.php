...
$classes = ($active ?? false)
            ? 'flex items-center px-4 py-3 text-sm font-semibold rounded-lg bg-premium-amber text-white transition-all duration-200 shadow-lg shadow-premium-amber/20'
            : 'flex items-center px-4 py-3 text-sm font-medium rounded-lg text-cream/70 hover:bg-forest-light hover:text-white transition-all duration-200';
@endphp
